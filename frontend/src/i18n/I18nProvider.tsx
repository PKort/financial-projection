...
const en: Record<string, string> = {
  ...
  'Skanuj paragon': 'Scan receipt',
  'Analizowanie paragonu…': 'Analyzing receipt…',
  'Zdjęcie jest analizowane lokalnie i nie jest zapisywane.': 'The photo is analyzed locally and is not stored.',
  'Domyślne konto dla paragonów': 'Default account for receipts',
  'Brak domyślnego konta': 'No default account',
  ...
  'Zmień zakres analizy': 'Change analytics date range',
  'Zmień zakres projekcji': 'Change projection date range',
  'Pokaż pełen zakres': 'Show full range',
  'Pokaż widok skrócony': 'Show compact view',
  'Wybierz datę początkową i końcową': 'Choose a start and end date',
